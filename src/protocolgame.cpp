...
if (player->getPlayerInfo(PLAYERINFO_MAXHEALTH) > 0)
	...
	msg->add<char>(player->getPlayerInfo(PLAYERINFO_LEVELPERCENT));
if (player->getPlayerInfo(PLAYERINFO_MAXMANA) > 0)
	...
	msg->add<char>(player->getPlayerInfo(PLAYERINFO_MAGICLEVEL));
	msg->add<char>(player->getPlayerInfo(PLAYERINFO_MAGICLEVELPERCENT));
	msg->add<char>(player->getPlayerInfo(PLAYERINFO_SOUL));
