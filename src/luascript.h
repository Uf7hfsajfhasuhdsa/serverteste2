...
class LuaInterface
{
	...
	protected:
		...
		static int32_t luaDoPlayerRemoveTarget(lua_State* L);//
		static int32_t luaGetMonsterNeedStorage(lua_State* L);
		static int32_t luaGetMonsterStorageKey(lua_State* L);	
		static int32_t luaGetStorageOnKill(lua_State* L);			
		...
		static int32_t luaDoTileSetFlag(lua_State* L);		
