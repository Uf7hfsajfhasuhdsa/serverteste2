...
#define SOFTWARE_NAME "Battlestadium Official - "
#define SOFTWARE_VERSION "[Source 1.0]"
#define MINOR_VERSION "X"
#define PATCH_VERSION "SERIES"
#define REVISION_VERSION "-"
#define SOFTWARE_CODENAME "Crying Damson"
#define SOFTWARE_DEVELOPERS "Mark Samman and The Forgotten Server Developers"
#define FORUMS "otland.net"
