...
class Monster : public Creature
{
	...
	public:
		...
		int32_t getNeedStorage() const {return mType->needStorage;}		
		std::string getStorageKey() const {return mType->storageKey;}
		int32_t getStorageOnKill() const {return mType->storageOnKill;}
