...
or (getPlayerVocation(cid) == 329)
or (getPlayerVocation(cid) == 330)
or (getPlayerVocation(cid) == 304) 
or (getPlayerVocation(cid) == 305)
or (getPlayerVocation(cid) == 306)
or (getPlayerVocation(cid) == 303) 
or (getPlayerVocation(cid) == 304) 
or (getPlayerVocation(cid) == 305) 
or (getPlayerVocation(cid) == 306) 
...
elseif (getPlayerVocation(cid) == 303) 
or (getPlayerVocation(cid) == 304) 
or (getPlayerVocation(cid) == 305) 
or (getPlayerVocation(cid) == 306) 
or (getPlayerVocation(cid) == 307) 
or (getPlayerVocation(cid) == 308)
or (getPlayerVocation(cid) == 309) then
doPlayerAddItem(cid,2293,1)
doPlayerAddItem(cid,2290,1)
doPlayerAddItem(cid,2303,1)
doPlayerAddItem(cid,2294,1)
