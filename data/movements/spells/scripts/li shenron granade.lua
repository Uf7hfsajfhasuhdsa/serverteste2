...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.2, 0)

local combat2 = createCombatObject()
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat2, COMBAT_PARAM_DISTANCEEFFECT, 47)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.2, 0)

local combat3 = createCombatObject()
setCombatParam(combat3, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat3, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat3, COMBAT_PARAM_DISTANCEEFFECT, 24)
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.2, 0)

local combat4 = createCombatObject()
setCombatParam(combat4, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat4, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat4, COMBAT_PARAM_DISTANCEEFFECT, 47)
setCombatFormula(combat4, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.2, 0)

local combat5 = createCombatObject()
setCombatParam(combat5, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat5, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat5, COMBAT_PARAM_DISTANCEEFFECT, 24)
setCombatFormula(combat5, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.2, 0)

local combat6 = createCombatObject()
setCombatParam(combat6, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat6, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat6, COMBAT_PARAM_DISTANCEEFFECT, 47)
setCombatFormula(combat6, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.2, 0)

local combat7 = createCombatObject()
setCombatParam(combat7, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat7, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat7, COMBAT_PARAM_DISTANCEEFFECT, 24)
setCombatFormula(combat7, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.2, 0)

local combat8 = createCombatObject()
setCombatParam(combat8, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat8, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat8, COMBAT_PARAM_DISTANCEEFFECT, 47)
setCombatFormula(combat8, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.2, 0)

local combat9 = createCombatObject()
setCombatParam(combat9, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat9, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat9, COMBAT_PARAM_DISTANCEEFFECT, 24)
setCombatFormula(combat9, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.2, 0)


local combat10 = createCombatObject()
setCombatParam(combat10, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat10, COMBAT_PARAM_EFFECT, 233)
setCombatParam(combat10, COMBAT_PARAM_DISTANCEEFFECT, 47)
setCombatFormula(combat10, COMBAT_FORMULA_LEVELMAGIC, -1.1, 0, -1.4, 0)
