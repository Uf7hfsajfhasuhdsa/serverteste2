...
freeza = {lookType=259} --LOOKTYPE NOWEGO TRANSU
ext = 1000

local config = {
				vocation = 344 , ---Vocation w ktora ma zmieniac
				mana = 0 , --Wymagana Mana
				efekt = 180 , -- Efekt ktory bedzie potransie [np prady co 1 sec na ludziku]
				przedtrans = 257 , -- id Vocation dla ktorej dostepny bedzie trans
...
---goku---
if getPlayerVocation(cid) == 257 then	
