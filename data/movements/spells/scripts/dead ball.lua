...
setCombatParam(combat5, COMBAT_PARAM_EFFECT, 230)
...
setCombatParam(combat6, COMBAT_PARAM_EFFECT, 230)
...
setCombatParam(combat7, COMBAT_PARAM_EFFECT, 230)
...
setCombatParam(combat8, COMBAT_PARAM_EFFECT, 230)
...
setCombatParam(combat9, COMBAT_PARAM_EFFECT, 230)
setCombatParam(combat9, COMBAT_PARAM_DISTANCEEFFECT, 40)
setCombatFormula(combat9, COMBAT_FORMULA_LEVELMAGIC, -1.5, 0, -1.5, 0)


local combat10 = createCombatObject()
setCombatParam(combat10, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat10, COMBAT_PARAM_EFFECT, 230)
setCombatParam(combat10, COMBAT_PARAM_DISTANCEEFFECT, 40)
