local items = {
{itemId = 2386, count = 1, chance = 20}, -- ITEM, QUANTIDADE, CHANCE
{itemId = 7872, count = 1, chance = 10},
{itemId = 7878, count = 1, chance = 10},
{itemId = 2433, count = 1, chance = 10},
{itemId = 2376, count = 1, chance = 10},
{itemId = 7891, count = 1, chance = 5},
{itemId = 3963, count = 1, chance = 3},
{itemId = 11491, count = 1, chance = 2},
{itemId = 7865, count = 1, chance = 1},
}
...
doPlayerSendCancel(cid, "Você somente poderá abrir uma nova Sword Box em " .. math.floor(exhaustion.get(cid, config.storageUse) / 60 + 1) .." minutos.") 
end
if (exhaustion.get(cid, config.storageUse) <= 60) then
