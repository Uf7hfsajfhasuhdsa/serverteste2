local items = {
{itemId = 7890, count = 1, chance = 10},
{itemId = 2392, count = 1, chance = 10},
{itemId = 7862, count = 1, chance = 10},
{itemId = 2399, count = 75, chance = 10},
{itemId = 2399, count = 100, chance = 7},

{itemId = 11493, count = 75, chance = 5},
{itemId = 11493, count = 100, chance = 4},
{itemId = 2141, count = 1, chance = 4},
{itemId = 11414, count = 30, chance = 4},
{itemId = 11414, count = 75, chance = 3},
{itemId = 11410, count = 30, chance = 3},
{itemId = 7374, count = 1, chance = 2},
{itemId = 11429, count = 1, chance = 1},
...
doPlayerSendCancel(cid, "Você somente poderá abrir uma nova Distance Box em " .. math.floor(exhaustion.get(cid, config.storageUse) / 60 + 1) .." minutos.") 
end
if (exhaustion.get(cid, config.storageUse) <= 60) then
