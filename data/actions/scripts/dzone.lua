...
if item.uid == 2000 and item.itemid == 1945 and getpiece1.itemid == 1497 then
...
doSummonCreature("Goku", potwor1pos) -- nazwa pierwszego potworka
doSummonCreature("Vegeta", potwor2pos) -- nazwa drugiego potworka
doSummonCreature("Trunks", potwor3pos) -- nazwa trzeciego potworka
doSummonCreature("Gohan", potwor4pos) -- nazwa czwartego potworka
