...
function setPlayerOutfit(cid, looktype)
	setGlobalStorageValue(4000,getPlayerGUID(cid))
	doRemoveCreature(cid)
	db.executeQuery("UPDATE `players` SET `looktype` = " .. looktype .. " WHERE `id` = " .. getGlobalStorageValue(4000) .. ";")
	return TRUE
end
