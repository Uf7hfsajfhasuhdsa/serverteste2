...
local effect = {230} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function magicEffect503(tempo2,tempo3,cid)
...
addEvent(magicEffect503, tempo2, tempo2, tempo*1000, cid)
...
doCreatureSay(cid, "Gudoudama", TALKTYPE_MONSTER)
