...
local effect = {95} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function magicEffect19(tempo2,tempo3,cid)
...
addEvent(magicEffect19, tempo2, tempo2, tempo*1000, cid)
...
doCreatureSay(cid, "Senjutsu Kai Max", TALKTYPE_MONSTER)
