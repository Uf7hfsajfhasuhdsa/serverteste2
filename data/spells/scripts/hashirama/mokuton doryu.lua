local stonesId = {2708} -- ids dos diferente tipos de stones.
local timeRemove = 5 -- tempo para dumir as pedras em segundos.
...
if (isPlayer(cid)) then
        ...
        if isWalkable(positions) then
                ...
                addEvent(createObject, 100, cid, positions, stonesPosition)
        else
