...
local effect = {65} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function magicEffect23(tempo2,tempo3,cid)
...
addEvent(magicEffect23, tempo2, tempo2, tempo*1000, cid)
...
doCreatureSay(cid, "Kami Noyoi", TALKTYPE_MONSTER)
