...
local effect = {280} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function magicEffect200(tempo2,tempo3,cid)
...
addEvent(magicEffect200, tempo2, tempo2, tempo*1000, cid)
...
doCreatureSay(cid, "Ninpou Byakugo no Jutsu", TALKTYPE_MONSTER)
