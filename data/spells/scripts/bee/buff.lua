...
local effect = {435} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function magicEffect120(tempo2,tempo3,cid)
...
local position120 = {x=getPlayerPosition(cid).x+1, y=getPlayerPosition(cid).y, z=getPlayerPosition(cid).z}
...
addEvent(magicEffect120, tempo2, tempo2, tempo*1000, cid)
