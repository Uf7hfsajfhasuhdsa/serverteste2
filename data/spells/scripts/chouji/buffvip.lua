...
local effect = {202} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
local health = 7500 -- A cada 1 segundo quantos aumentar de vida
...
doCreatureSay(cid, "Baika no Jutsu", TALKTYPE_MONSTER)
