...
setCombatFormula(combat1, COMBAT_FORMULA_LEVELMAGIC, -1.5, -4.25, -6.5, -9.25)

local combat2 = createCombatObject() 
setCombatParam(combat2, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat2, COMBAT_PARAM_DISTANCEEFFECT, 64)
setCombatFormula(combat2, COMBAT_FORMULA_LEVELMAGIC, -1.5, -4.25, -6.5, -9.25)

local combat3 = createCombatObject() 
setCombatParam(combat3, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat3, COMBAT_PARAM_DISTANCEEFFECT, 63)
setCombatFormula(combat3, COMBAT_FORMULA_LEVELMAGIC, -1.5, -4.25, -6.5, -9.25)

local combat4 = createCombatObject() 
setCombatParam(combat4, COMBAT_PARAM_TYPE, COMBAT_PHYSICALDAMAGE)
setCombatParam(combat4, COMBAT_PARAM_DISTANCEEFFECT, 64)
setCombatFormula(combat4, COMBAT_FORMULA_LEVELMAGIC, -1.5, -4.25, -6.5, -9.25)
