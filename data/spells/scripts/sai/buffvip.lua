...
local effect = {49} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function magicEffect501(tempo2,tempo3,cid)
...
addEvent(magicEffect501, tempo2, tempo2, tempo*1000, cid)
...
doCreatureSay(cid, "Ninpou Choujuu Boei Max", TALKTYPE_MONSTER)
