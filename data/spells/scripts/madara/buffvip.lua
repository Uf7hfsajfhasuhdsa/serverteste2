...
local effect = {90} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function magicEffect500(tempo2,tempo3,cid)
...
addEvent(magicEffect500, tempo2, tempo2, tempo*1000, cid)
