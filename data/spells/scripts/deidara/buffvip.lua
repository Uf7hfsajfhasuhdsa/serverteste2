...
local effect = {73} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function magicEffect504(tempo2,tempo3,cid)
...
addEvent(magicEffect504, tempo2, tempo2, tempo*1000, cid)
...
doCreatureSay(cid, "Explosion Art", TALKTYPE_MONSTER)
