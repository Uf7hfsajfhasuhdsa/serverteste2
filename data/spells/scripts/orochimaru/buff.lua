...
local effect = {438} -- effect no player, caso queira apenas 1, basta remover os outros numeros.
...
function magicEffect101(tempo2,tempo3,cid)
...
addEvent(magicEffect101, tempo2, tempo2, tempo*1000, cid)
...
doCreatureSay(cid, "Jin Yoroi", TALKTYPE_MONSTER)
