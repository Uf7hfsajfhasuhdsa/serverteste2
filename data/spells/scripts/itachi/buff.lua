...
function magicEffect98(tempo2,tempo3,cid)
...
local position98 = {x=getPlayerPosition(cid).x+1, y=getPlayerPosition(cid).y, z=getPlayerPosition(cid).z}
...
addEvent(magicEffect98, tempo2, tempo2, tempo*1000, cid)
...
doCreatureSay(cid, "Fuumetsu Sharingan", TALKTYPE_MONSTER)
    
doSendMagicEffect(position98, 134)
