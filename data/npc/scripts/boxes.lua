...
local moeda = 11460
local t = {
   ["distance box"] = {150, 11416}, -- ["nome do item"] = {quanto vai custar, id do tem que sera vendido}
   ["sword box"] = {150, 11417}, -- ["nome do item"] = {quanto vai custar, id do tem que sera vendido}
   ["gloves box"] = {150, 11418}, -- ["nome do item"] = {quanto vai custar, id do tem que sera vendido}
   }
...
selfSay('Para Adquirir Fun Coins, basta fazer as tasks / quests!', cid)
...
str = str.." {"..name.."} por "..pos[1].." Fun Coins, "
end
str = str .. "."
...
elseif t[msg] then
                if doPlayerRemoveItem(cid,moeda,t[msg][1]) then
                       doPlayerAddItem(cid,t[msg][2],1)
                        ...
                        npcHandler:say("Voce nao tem Fun Coins suficientes !", cid)
                end
end
return TRUE
end
