...
doBroadcastMessage("Noticia: Jornal Shinobi informa: [NPC] Bounty Hunter , informou que o shinobi "..msg.." esta procurado, e agora o seu nivel de recompensa e procura é "..getPlayerStorageValue(getPlayerByNameWildcard(msg), 13131)..".", BroadCast_Type)
else
